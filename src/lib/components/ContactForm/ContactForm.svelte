<script lang="ts">
  ...
  import { contactFormSchema, type ContactFormSchema } from "./schema";
   ...
   let { contactFormInput } : {  contactFormInput: SuperValidated<Infer<ContactFormSchema>> }  = $props()
...
<Form.Field form={contactForm} name="name">
    <Form.Control>
        {#snippet children({props})}
            ...
            <Input {...props} bind:value={$contactFormData.name}
...
<Form.Field form={contactForm} name="email">
    <Form.Control>
        {#snippet children({props})}
            ...
            <Input {...props} bind:value={$contactFormData.email}
...
<Form.Field form={contactForm} name="message">
    ...
    <Form.Label>{m['contactForm.message.label']()}</Form.Label>
            <Input {...props} bind:value={$contactFormData.message}
